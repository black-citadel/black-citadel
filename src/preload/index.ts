...
export interface ElectronAPI {
  ...
  readIngressClass: (name: string, namespace: string) => Promise<k8s.V1IngressClass>;
  ...
  readMutatingWebhookConfiguration: (name: string, namespace: string) => Promise<k8s.V1MutatingWebhookConfiguration>;
  readPriorityClass: (name: string, namespace: string) => Promise<k8s.V1PriorityClass>;
  readRuntimeClass: (name: string, namespace: string) => Promise<k8s.V1RuntimeClass>;
  readValidatingWebhookConfiguration: (name: string, namespace: string) => Promise<k8s.V1ValidatingWebhookConfiguration>;
  readClusterRoleBinding: (name: string, namespace: string) => Promise<k8s.V1ClusterRoleBinding>;
  readClusterRole: (name: string, namespace: string) => Promise<k8s.V1ClusterRole>;
  ...
  readCSIDriver: (name: string, namespace: string) => Promise<k8s.V1CSIDriver>;
  readCSINode: (name: string, namespace: string) => Promise<k8s.V1CSINode>;
  ...
  readVolumeAttachment: (name: string, namespace: string) => Promise<k8s.V1VolumeAttachment>;
...
try {
  contextBridge.exposeInMainWorld('electronAPI', {
    ...
    readIngressClass: (name: string, namespace: string) => ipcRenderer.invoke('readIngressClass', name, namespace),
    ...
    readMutatingWebhookConfiguration: (name: string, namespace: string) => ipcRenderer.invoke('readMutatingWebhookConfiguration', name, namespace),
    readPriorityClass: (name: string, namespace: string) => ipcRenderer.invoke('readPriorityClass', name, namespace),
    readRuntimeClass: (name: string, namespace: string) => ipcRenderer.invoke('readRuntimeClass', name, namespace),
    readValidatingWebhookConfiguration: (name: string, namespace: string) => ipcRenderer.invoke('readValidatingWebhookConfiguration', name, namespace),
    readClusterRoleBinding: (name: string, namespace: string) => ipcRenderer.invoke('readClusterRoleBinding', name, namespace),
    readClusterRole: (name: string, namespace: string) => ipcRenderer.invoke('readClusterRole', name, namespace),
