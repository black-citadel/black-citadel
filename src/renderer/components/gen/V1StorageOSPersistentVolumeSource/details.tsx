...
import type { V1StorageOSPersistentVolumeSource } from "@kubernetes/client-node";
import { ObjectReferenceDetails } from "../V1ObjectReference/details";

export const StorageOSPersistentVolumeSourceDetails = ({ resourceData }: { resourceData: V1StorageOSPersistentVolumeSource }): JSX.Element => {
        ...
        <>
            ...
            {resourceData.secretRef && (
                <Container title="Secret Ref">
                    <ObjectReferenceDetails resourceData={ resourceData.secretRef } />
                </Container>
            )}
