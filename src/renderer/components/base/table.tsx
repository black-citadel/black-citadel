...
export function TableHeader({ className, ...props }: React.ComponentPropsWithoutRef<'th'>) {
  ...
  return (
    <th
      ...
      className={clsx(
        className,
        'border-b border-b-zinc-950/10 px-4 py-2 font-medium tracking-wide text-xs uppercase  first:pl-[var(--gutter,theme(spacing.2))] last:pr-[var(--gutter,theme(spacing.2))] dark:border-b-white/10',
...
export function TableCell({ className, children, ...props }: React.ComponentPropsWithoutRef<'td'>) {
  ...
  return (
    <td
      ...
      className={clsx(
        className,
        'relative align-top px-4 first:pl-[var(--gutter,theme(spacing.2))] last:pr-[var(--gutter,theme(spacing.2))]',
