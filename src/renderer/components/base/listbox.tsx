  ...
  return (
    <Headless.Listbox {...props} multiple={false}>
      ...
      >
        ...
        />
        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2 w-6">
          <svg
            className="size-6 stroke-zinc-500 group-data-[disabled]:stroke-zinc-600 sm:size-4 dark:stroke-zinc-400 "
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
      ...
      {({ selectedOption }) => {
        ...
        return (
          <div
            className={clsx(
              // Basic layout
              'group/option grid cursor-default grid-cols-[theme(spacing.5),1fr] items-baseline gap-x-2 rounded-xs py-2.5 pl-2 pr-3.5 sm:grid-cols-[theme(spacing.4),1fr] sm:py-1.5 sm:pl-1.5 sm:pr-3',
              // Typography
