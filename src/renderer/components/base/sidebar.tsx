...
export function SidebarHeading({ className, ...props }: React.ComponentPropsWithoutRef<'h3'>) {
  return (
    <h3 {...props} className={clsx(className, 'mb-1 px-2 text-xs font-medium text-zinc-500 dark:text-zinc-400 tracking-wider')} />
  )
}
...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  const classes = clsx(
    // Base
    'flex w-full items-center gap-3 cursor-pointer rounded-lg px-2 py-2.5 text-left text-base/6 font-bold text-zinc-950 sm:py-2 sm:text-sm/5',
